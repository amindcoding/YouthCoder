        ...
        <div className="articels-grid">
          ...
          <Grid>
            <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
              ...
              <CardActions border>
                <a href="https://www.hostinger.co.id/tutorial/apa-itu-html" target="_blank">
            ...
            <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
              ...
              <CardActions border>
                <a
                  href="https://www.hostinger.co.id/tutorial/apa-itu-javascript#:~:text=JavaScript.%20Fungsi%20JavaScript%2C%20atau%20yang%20sering%20disingkat%20JS%2C,lanjut%20tanpa%20mengharuskan%20developer%20melakukan%20coding%20dari%20awal."
                  target="_blank"
                >
                  <Button colored>Lihat Lengkap</Button>
                </a>
            ...
            <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
              ...
              <CardActions border>
                <a href="https://blog.rumahweb.com/apa-itu-nodejs-adalah/" target="_blank">
                  <Button colored>Lihat Lengkap</Button>
                </a>
              </CardActions>
              <CardMenu style={{ color: '#fff' }}>
        ...
        <div className="articels-grid">
          ...
          <Grid>
            <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
              ...
              <CardActions border>
                <a href="https://www.youtube.com/watch?v=NBZ9Ro6UKV8&list=PLFIM0718LjIVuONHysfOK0ZtiqUWvrx4F" target="_blank">
            ...
            <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
              ...
              <CardText>Pelajari lebih jelas dengan klik play video</CardText>
              <CardActions border>
                <a href="https://www.youtube.com/watch?v=RUTV_5m4VeI&list=PLFIM0718LjIWXagluzROrA-iBY9eeUt4w" target="_blank">
                  <Button colored>Play Video</Button>
                </a>
              </CardActions>
              <CardMenu style={{ color: '#fff' }}>
            ...
            <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
              <CardTitle
                style={{
                  color: '#fff',
                  height: '176px',
                  background: 'url(https://berita.teknologi.id/uploads/2018/04/logo-og.png) center / cover',
                }}
              >
                React JS
              </CardTitle>
              <CardText>Pelajari lebih jelas dengan klik play video</CardText>
              <CardActions border>
                <a href="https://www.youtube.com/watch?v=ZNVRETPPW24&list=PLCZlgfAG0GXALZIcEe2t3XVuQ50JYbsbA" target="_blank">
                  <Button colored>Play Video</Button>
                </a>
              </CardActions>
              <CardMenu style={{ color: '#fff' }}>
        ...
        <div className="articels-grid">
          ...
          <Grid>
            <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
              ...
              <CardActions border>
                <Button href="https://drive.google.com/file/d/1p6JDm83GGHX6CLKyervJBIf4Rp8PS-w2/view?usp=sharing" target="_blank" colored>
                  Download PDF
                </Button>
              </CardActions>
              <CardMenu style={{ color: '#fff' }}>
            ...
            <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
              ...
              <CardActions border>
                <Button href="https://drive.google.com/file/d/13eN6B3bK7Bkv-ErZGsClhrvweCNXI4A7/view?usp=sharing" target="_blank" colored>
                  Download PDF
                </Button>
              </CardActions>
              <CardMenu style={{ color: '#fff' }}>
            ...
            <Card shadow={5} style={{ minWidth: '450', margin: 'auto' }}>
              ...
              <CardActions border>
                <Button href="https://drive.google.com/file/d/1juqkEknUtPeIhSfNKlAMWTnSsAcxPDcG/view?usp=sharing" target="_blank" colored>
                  Download PDF
                </Button>
              </CardActions>
              <CardMenu style={{ color: '#fff' }}>
